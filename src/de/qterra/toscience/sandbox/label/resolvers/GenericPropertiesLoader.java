...
/**
 * @author aquast Class is to facilitate and standardize loading Vocabulary form
 *         local files - If remote loading is not advised
 */
public class GenericPropertiesLoader {
    ...
    public Map<String, String> loadVocabMap(String propertiesFileName) {
        ...
        String propertiesPath = propertiesFileName;
        try {
    ...
    private Properties loadPropertiesFromFile(String propertiesPath) {
        ...
        try (Reader propReader = new FileReader(System.getProperty("user.dir") + "/resources/" + propertiesPath)) {
    ...
    private LinkedHashMap<String, String> loadMapFromFile(String propertiesPath) {
        ...
        try {
            Reader propReader = new FileReader(System.getProperty("user.dir") +  "/resources/" + propertiesPath);
